...
<div class="container">
	<table class=" myOwn2">
		...
		<tbody>
			...
			<tr id="showPw" style="display: none;" height="80">
				<th colspan="3" style="width: 100px;"><p
						style="font-size: 50px"></p></th>
			</tr>
			<tr>
	...
	<input type="button" id="changeP"  class="btn btn-danger" value="비밀번호 변경"
		style="display: none;">
		<input type="button" id="backPage" class="btn btn-warning" value="뒤로가기"
		style="display: none;" onclick="location.href = 'loginForm.do'">
	<form class="pwForm">
		<div class="showPwCh" style="display: none;">
			<div class="col-md-12">
				<p style="font-size: 20px; text-align: left">비밀번호</p>
				<br>
				<input class="form-control" type="password" name="pw" id="pw"
					placeholder="비밀번호를 입력하세요" required
					style="width: 540px; background-color: 808080;">

				<div class="valid-feedback" style="display: none">사용가능한 비밀번호
					입니다</div>
				<div class="invalid-feedback" style="display: none">비밀번호를 다시
					입력하세요 확인하세요</div>
			</div>
			<div class="col-md-12">
				<br>
				<p style="font-size: 20px; text-align: left">비밀번호 재확인</p>
				<br>
				<input class="form-control" type="password" name="rePw" id="rePw"
			...
			<br>
			<br>
			<input type="submit" class="btn btn-danger" value="비밀번호 변경 완료"
